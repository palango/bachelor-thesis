...
\begin{tikzpicture}[scale=1.5]
  ...
  \node (x) at (1.5,0.05) [label=below:$\alpha$]{};
  ...
  \node (x) at (4,0.66666) [label=right:{$\eta=j$}]{};
  \node (x) at (4.5,3.66666) [label=right:{$\eta=j+1$}]{};
  \node (x) at (0.66666,4) [label=left:{$\xi=i+1$}]{};
  \node (x) at (0.66666+3,4) [label=left:{$\xi=i+1$}]{};
