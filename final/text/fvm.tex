...
ausreichend. Sie geht von der Annahme aus, dass der Wert $f_P$ im Mittelpunkt des Kontrollvolumens
...
Beim Upwind-Verfahren (auch Upwind Differencing Scheme, UDS) wird der Verlauf von $\phi$ durch eine Treppenfunktion approximiert, die formuliert
...
Beim Zentraldifferenzen-Verfahren (auch Central Differencing Scheme, CDS) wird der
