...
die beiden Ableitungen $\pder[\phi]{x}$ und $\pder[\phi]{y}$:
\begin{align}
...
\end{align}
Im nächsten Schritt muss nun $C$ durch die umgebenden Zellenmittelpunkte ausgedrückt werden.
\begin{align*}
   C\big\vert_{\tilde{e}}
   =& C\big\vert_{\tilde{E}}
...
\begin{equation}
  \begin{IEEEeqnarraybox}[][c]{rCl}
    \int\int_{P} \underbrace{\Pi_{\phi}(\xi, \eta) det(J) }_{h} d\xi d\eta
...
\centering
\caption{Größen für die Berechnung der Metriken}
\end{figure}
